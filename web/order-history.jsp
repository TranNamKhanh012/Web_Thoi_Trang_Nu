...
<head>
    ...
    <style>
        ...
        .order-history-list { max-width: 900px; margin: 0 auto; }
        .order-card { background: white; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 20px; }
        .order-header { padding: 15px 20px; background: #f7f7f7; border-bottom: 1px solid #ddd; display: flex; justify-content: space-between; align-items: center; }
        .order-header h4 { margin: 0; }
        .order-header span { font-weight: bold; }
        .order-body { padding: 20px; }
        .order-meta { display: flex; justify-content: space-between; margin-bottom: 15px; }
        .order-item { display: flex; align-items: center; padding: 10px 0; border-bottom: 1px solid #eee; }
        .order-item:last-child { border-bottom: none; }
        .order-item img { width: 60px; height: 60px; margin-right: 15px; }
        .order-item-info { flex-grow: 1; }
        .order-item-info span { display: block; }
        .order-item-info .item-price { color: #888; }
    </style>
</head>
<body>
