...
<head>
    ...
    <title>${empty article.id ? 'Thêm' : 'Sửa'} Bài viết</title>
...
<body>
    <div class="admin-layout">
        ...
        <main class="admin-main-content">
             <header class="admin-header"><h1>${empty article.id ? 'Thêm Bài viết mới' : 'Chỉnh sửa Bài viết'}</h1></header>
            
            <div class="form-section">
                <form action="articles" method="POST">
                    <input type="hidden" name="action" value="save">
                    <%-- Nếu là sửa thì gửi ID đi --%>
