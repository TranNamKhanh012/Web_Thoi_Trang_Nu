                        ...
                        <div class="checkout-wrapper">
                            <div class="billing-details">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" name="phone" required pattern="[0-9]{10}" maxlength="10" title="Số điện thoại phải bao gồm 10 chữ số.">
                                </div>
                            </div>
                            ...
                            <div class="order-summary">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr style="font-weight: bold; border-top: 1px solid #eee; padding-top: 10px;">
                                        <td>Tạm tính</td>
                                        <td style="text-align: right;"><fmt:formatNumber value="${sessionScope.cart.totalMoney}" type="number"/>đ</td>
                                    </tr>

                                    <%-- GIẢM GIÁ (chỉ hiển thị nếu có) --%>
                                    <c:if test="${sessionScope.cart.discount > 0}">
                                        <tr>
                                            <td>Giảm giá (Đơn từ ${Cart.PROMO_QUANTITY_THRESHOLD} sản phẩm)</td>
                                            <td style="text-align: right;">- <fmt:formatNumber value="${sessionScope.cart.discount}" type="number"/>đ</td>
                                        </tr>
                                    </c:if>

                                    <%-- TỔNG CỘNG CUỐI CÙNG --%>
                                    <tr style="font-weight: bold; font-size: 18px; border-top: 1px solid #eee; padding-top: 10px;">
                                        <td>Tổng cộng</td>
                                        <td style="text-align: right; color: #dc3545;"><fmt:formatNumber value="${sessionScope.cart.finalTotal}" type="number"/>đ</td>
                                    </tr>
