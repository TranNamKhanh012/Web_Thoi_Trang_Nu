...
<head>
    ...
    <style>
        ...
        .article-wrapper h1 { font-size: 32px; font-weight: 700; margin-bottom: 20px; }
        .article-wrapper .article-meta { font-size: 14px; color: #888; margin-bottom: 25px; }
        .article-wrapper img.cover-image { width: 100%; border-radius: 8px; margin-bottom: 30px; }
        
        .article-content { font-size: 16px; line-height: 1.8; color: #333; }
        .article-content p { margin-bottom: 20px; }
        .article-content h3 { font-size: 22px; font-weight: 600; margin-top: 30px; margin-bottom: 15px; }
    </style>
</head>
<body>
